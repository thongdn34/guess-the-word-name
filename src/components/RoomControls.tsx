...
export default function RoomControls({
  ...
  const canStart =
    currentRound &&
    currentRound.id &&
    currentRound.importerId === "pending" &&
    players.length >= 2;
  const canMarkWinner =
    currentRound &&
      ...
      <div className="space-y-4">
        ...
        {/* Mark Winner Section */}
        {
          <div className="space-y-3">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        ...
                        setSelectedWinners(
                          selectedWinners.filter((id) => id !== player.id)
                        );
                      }
                    }}
            ...
            >
              {isMarkingWinner
                ? "Marking..."
                : `Mark ${selectedWinners.length} Winner${
        ...
        {room.status === "in_round" && !canMarkWinner && (
          <div className="text-center text-gray-600 py-4">
            ...
            <p className="text-sm">
              Wait for the round to complete to mark a winner
            </p>
          </div>
        )}
      </div>
